...
let data = [
  {
    ...
    ProdImg: "../Images/futureDue/glossier-futuredew-carousel-01.avif",
  ...
  },
  {
    ...
    ProdImg:
      "../Images/Cleanser-Concentrate/glossier-cleanser-concentrate-carousel-01.avif",
    actor: "../Images/Cleanser-Concentrate/hover.avif",
    price: 19,
    type: "Cleanser",
    skin: "Dry",
  },
  {
    ...
    ProdImg:
      "../Images/Priming-mosturiser/glossier-priming-moisturizer-carousel-01.avif",
    actor: "../Images/Priming-mosturiser/hover.avif",
    price: 24,
    type: "Moisturizer",
    skin: "Normal",
  },
  {
    ...
    ProdImg:
      "../Images/primaring-mosturizer-balance/glossier-priming-moisturizer-balance-carousel-01_4b6e0d57-d05e-46fc-8610-ab6201468c2c.avif",
    actor: "../Images/primaring-mosturizer-balance/hover.avif",
    price: 25,
    type: "Moisturizer",
    skin: "Oily",
  },
  {
    ...
    ProdImg:
      "../Images/priming-mosturizer-rich/glossier-priming-moisturizer-rich-carousel-01.avif",
    actor: "../Images/priming-mosturizer-rich/hover.avif",
    price: 35,
    type: "Moisturizer",
    skin: "Dry",
  },
  {
    ...
    ProdImg:
      "../Images/invisible-shileld/glossier-invisible-shield-carousel-01_f6471fa7-9197-4c39-8cec-00ab11b7691b.avif",
    actor: "../Images/invisible-shileld/hover.avif",
    price: 25,
    type: "sunscreen",
    skin: "Normal",
  },
  {
    ...
    ProdImg:
      "../Images/after-baume/glossier-after-baume-carousel-01_23fe78f1-1917-42e6-9448-b7f44e65acfc.avif",
    actor: "../Images/after-baume/hover.avif",
    price: 28,
    type: "Moisturizer",
    skin: "Oily",
  },
  ...
  },
  {
    ...
    Name: "Solution",
    content: "Choose three balms",
    ProdImg: "../Images/Solution/glossier-solution-carousel-01.avif",
    actor: "../Images/Solution/hover.avif",
    price: 26,
    type: "treatment",
    skin: "Normal",
  },
...
function DisplyData(data) {
  data.forEach((element) => {
    ...
    btn.addEventListener("click", () => {
      ...
      if (data.some((cartItem) => cartItem.id === element.id)) {
...
Sort.addEventListener("change", (data) => {
  let dummyData = [
    ...
    },
    {
      ...
      content: "Choose three balms",
      ProdImg:
        "../Images/Solution/glossier-solution-carousel-01.avif",
      actor: "../Images/Solution/hover.avif",
      price: 26,
      type: "treatment",
      skin: "Normal",
